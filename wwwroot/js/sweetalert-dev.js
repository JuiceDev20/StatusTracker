...
var setParameters = function setParameters(params) {
  ...
  if (params.imageUrl) {
    ...
    if (params.~/assets/Imagesize) {
      var dimensions = params.~/assets/Imagesize.toString().split('x');
      var imgWidth = dimensions[0];
      var imgHeight = dimensions[1];

      if (!imgWidth || !imgHeight) {
        logStr('Parameter ~/assets/Imagesize expects value with format WIDTHxHEIGHT, got ' + params.~/assets/Imagesize);
      } else {
        _imgWidth = imgWidth;
